...
const ui = {
  ...
  "zh-tw": {
    "nav.home": "首頁",
    "nav.about": "關於本站",
    "nav.search.placeholder": "搜尋檢查點…",
    "cp.prerequisites": "先備知識",
    "cp.dependents": "後續應用",
    "cp.updated": "最後更新",
    "cp.tags": "標籤",
    "cp.translation_pending": "翻譯中",
    "index.checkpoints": "檢查點",
    "index.subcategories": "子分類",
    "level.elementry": "入門",
    "level.basis": "基礎",
    "level.essential": "必備",
    "level.advanced": "進階",
    "level.cutting-edge": "前沿",
    "category.tricks": "技巧",
    "category.proof": "證明",
    "category.homework": "習題",
    "category.side-lines": "補充",
    "theme.toggle": "切換主題",
    "lang.switch": "語言",
  },
